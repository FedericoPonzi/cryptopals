...
fn decrypt_cbc_mode(cipherlines: &[u8], key: &[u8; 16]) -> Vec<u8> {
    Pkcs7::remove_padding_unchecked(crypto::aes::cbc::decrypt(key, cipherlines))
}

#[cfg(test)]
mod test {
    use crate::ex_10_cbc_mode::decrypt_cbc_mode;
    const EXPECTED: &str = r#"I'm back and I'm ringin' the bell 
...
"#;
    #[test]
    fn test_decipher() {
        let b64_cipherlines: String = include_str!("../res/ex_10.txt")
            .lines()
            .collect::<Vec<&str>>()
            .join("");
