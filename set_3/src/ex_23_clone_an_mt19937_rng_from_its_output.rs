...
fn clone_mt19937_rng(rng: &mut Mt19937MersenneTwisterRng) -> Mt19937MersenneTwisterRng {
    Mt19937MersenneTwisterRng::clone_from_output(rng)
}

#[cfg(test)]
mod test {
    use crate::ex_23_clone_an_mt19937_rng_from_its_output::clone_mt19937_rng;
    use crypto::random::Mt19937MersenneTwisterRng;

    #[test]
    fn test_clone() {
        let mut rng = Mt19937MersenneTwisterRng::new();
        let mut received = clone_mt19937_rng(&mut rng);
